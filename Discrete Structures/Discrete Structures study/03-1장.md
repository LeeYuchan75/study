...
### p.24 함수를 부분집합으로 설명하는 부분 공부 pdf 내용 : ' A function f: A → B can also be defined as a subset of A× B(a relation). This subset is restricted to be a relation where no two elements of the relation have the same first element.'
